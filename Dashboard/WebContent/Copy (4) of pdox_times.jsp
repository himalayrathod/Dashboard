	...
	<table class = "inlineIt" bgcolor = "#8a7f8d" style="outline: thin solid">
		...
		<tr>
			<td  align = "center">
				...
				<input type = "radio"
					   name = "taskQueueButtons"
					   id = "ZoningTableButton" >
			</td>
		</tr>
	
		<tr>
			<td>
				<table id = "SPRTable" border = "show">
				<tr>
					<td>Task</td><td>SPR</td>
				</tr>
				...
				<tr>
					<td colspan = 2>
						<%=flowqueue[0][0] %> <b><%=flowqueue[0][2]%></b> tasks from <b><%=flowqueue[0][1] %></b> projects <br>
					</td>
				</tr>
				</table>
			</td>
		...
		<tr>
			<td>
				...
				<tr>
					<td colspan = 2>
						<%=flowqueue[1][0] %> <b><%=flowqueue[1][2]%></b> tasks from <b><%=flowqueue[1][1] %></b> projects <br>
					</td>
				</tr>
				</table>
			</td>
		...
		<tr>
			<td>
				<table id = "ZoningTable" border = "show">
				<tr>
					<td>Task</td><td>Zoning</td>
				</tr>
				...
				<tr>
					<td colspan = 2>	
						<%=flowqueue[2][0] %> <b><%=flowqueue[2][2]%></b> tasks from <b><%=flowqueue[2][1] %></b> projects <br>
					</td>
				</tr>
				</table>
			</td>
