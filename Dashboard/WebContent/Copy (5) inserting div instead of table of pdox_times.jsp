...
<form id = "taskQueForm" onClick = "task_table_selected()">
	<table id = "taskQueueTable"  style="outline: thin solid;" align = "center">
		...
		<tr id = "taskCountTableOuterTableRow" >
			<td>
				<table id = "taskCountTable" CELLPADDING="0" CELLSPACING="0" border = "show">
				<tr>
		...
		<tr id = "taskByAgeTableOuterTableRow">
			<td>
				<table id = "taskByAgeTable" CELLPADDING="0" CELLSPACING="0" border = "show">
				<tr>
		...
		<tr id = "ownerByTaskAgeTableOuterTableRow">
			<td valign=top >
				<table  id = "ownerByTaskAgeTable" CELLPADDING="0" CELLSPACING="0" border = "show">
				<tr>
