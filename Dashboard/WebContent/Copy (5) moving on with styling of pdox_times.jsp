...
<form id = "taskQueForm" onClick = "task_table_selected()">
	<table class = "inlineIt" bgcolor = "#8a7f8d" style="outline: thin solid;">
		...
		<tr>
			<td  align = "center">
				...
				<input type = "radio"
					   ...
					   id = "sumOfAllTableButton" checked>
				
				<b>Age</b>	
				<input type = "radio"
					   name = "taskQueueButtons"
					   id = "taskSplitByAgeTableButton">
		...
		<tr>
			<td>
				<table id = "taskQueueSplitSumOfAll" bgcolor="99CCFF" border = "show">
				<tr>
		...
		<tr>
			<td>
				<table id = "taskQueueSplitAgeGroup" bgcolor="99CCFF" border = "show">
				<tr>
